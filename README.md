 ...
 * Мне **17 лет**! Это мой последний учебный день в школе, поэтому моя активность может быть многократно снижена.
 ...
 * Активный пользователь **MacOS** на своем новеньком (почти) MacBook Air (M1)
 ...
 * __Secret Project 1__ - Проект в разработке, но планируется публичный анонс (часть компонентов может быть выложена в open source).
 * __Secret Project 2__ - Другой проект в разработке, планируется публичный анонс, но без open source.
